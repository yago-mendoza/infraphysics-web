...
- Admin reports default to 30 UTC days and reject invalid dates or ranges over 366 days before database work. The Worker repeats validation; exploration selector options also stay within the range. These bounds limit historical scans, not traffic volume inside a period.
