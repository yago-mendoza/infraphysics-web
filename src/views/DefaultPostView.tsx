// Default post view — used for threads, bits2bricks, and other non-project categories
...
interface DefaultPostViewProps {
  post: Post;
}

export const DefaultPostView: React.FC<DefaultPostViewProps> = ({ post }) => {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-th-surface-alt border border-th-border rounded-sm">
          ...
          <div>
            ...
            {post.github ? (
              ...
              <span className="text-sm text-th-tertiary">&mdash;</span>
            )}
          </div>
        </div>
