...
/** Copy content for context (notes, an article's text): the rocket, wherever that action appears. */
export const RocketIcon: React.FC<{ size?: number; className?: string }> = ({ size = 16, className }) => (
...
/* Like button: a thumbs-up (the name is kept so the reaction hook, CSS and KV key stay untouched). */
