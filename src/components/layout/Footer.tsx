    ...
    <footer className="w-full py-12 mt-16 border-t border-gray-200 relative z-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-[10px] uppercase tracking-wider text-gray-400 mb-4">Explore</h4>
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/contact" className="text-xs text-gray-600 hover:text-gray-900 transition-colors">Contact</Link>
            </nav>
          </div>

          {/* Contact */}
          <div>
            <h4 className="text-[10px] uppercase tracking-wider text-gray-400 mb-4">Contact</h4>
            <nav className="flex flex-col gap-2">
              <a href="mailto:contact@infraphysics.net" className="text-xs text-gray-600 hover:text-gray-900 transition-colors">
                contact@infraphysics.net
              </a>
              <a href="https://github.com/yago-mendoza" target="_blank" rel="noopener noreferrer" className="text-xs text-gray-600 hover:text-gray-900 transition-colors flex items-center gap-1">
