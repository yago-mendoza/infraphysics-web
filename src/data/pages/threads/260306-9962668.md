...
lead: "OpenAI tested whether their models can hide their chain-of-thought from safety monitors. The headline that spread: AI cannot lie. The correct headline: AI cannot yet lie. This number doesn't surprise me, and my gut says it's only going up. The economy pushes scaling harder than any interpretability lab can push back, regulation lags like it always does, and we'll probably need to hit a wall before we react. I just hope that when we do, someone's hand is close enough to the lever."
