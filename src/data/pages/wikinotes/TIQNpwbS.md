...
- HNSW (Hierarchical Navigable Small World graphs): builds a graph where similar vectors are neighbors, hopping through ~40 nodes instead of checking all 10M vectors, O(n) → O(log n)
