...
- The SPA index loads eagerly. Wikinote content loads on demand, only when the user opens a specific note. This keeps initial load fast (the index is metadata only, ~50KB for 500+ notes).
