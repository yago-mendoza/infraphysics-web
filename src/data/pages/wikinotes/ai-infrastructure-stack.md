...
- [[AiAccel5|AI accelerator]] : : Hardware supplies physical compute and memory limits that the serving layers must expose efficiently
- [[MdlCmp8R|model compression]] : : Compression changes representation, but runtime and hardware determine whether it becomes useful performance
- [[AgSys4mK|agentic system]] : : Agent orchestration adds actions, permissions and environment feedback above model serving
- [[DepRisk4|deployment risk]] : : A failure or overprivileged interface at any layer can change the risk of the complete system
