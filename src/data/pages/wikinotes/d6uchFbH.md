...
A benchmark is a standardized task distribution plus a scoring procedure used to compare systems. In ML, examples include [[vYejZdKc|MMLU]] and [[zGQrmDMu|HumanEval]]. The score compresses many observations into something comparable, which is both its value and its danger.
...
- [[CybEval7|cybersecurity evaluation]] : : Cyber benchmarks are unusually sensitive to permissions, isolation and time horizon
