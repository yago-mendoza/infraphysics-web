...
- Can only rearrange knowledge already baked in during [[2oNdlB5L|pre-training]], never creating new knowledge.
...
- [[mCK28lZ6]] : : If an AI crafts By from Bx through reflection, those pairs feed iterative DPO, the fastest path
