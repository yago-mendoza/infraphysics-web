...
- Four basic operations ([[Uf7pLs4Q|CRUD]]): `INSERT` (create), `SELECT` (read), `UPDATE` (update), `DELETE` (delete)
- Tables, columns, rows, relations (JOIN), indexes
- Dialects: PostgreSQL, MySQL, [[Tb5mWr3J|SQLite]], SQL Server -- the core is the same, the extras vary
