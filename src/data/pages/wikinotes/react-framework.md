...
- InfraPhysics uses React 19 + [[Vp8rBm5J|Vite]] 6. All content compiles at build time to static HTML/JSON. The browser loads React, which renders the UI. No backend, just static files on [[Fs8tBm3G|Cloudflare Pages]]. Including the Second Brain: 100% frontend, wikinotes compiled to JSON, graph and search all in the browser.
