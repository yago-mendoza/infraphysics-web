...
- [[Eb4kN7xS|Exposure bias]]: during SFT the model always sees perfect human-written context, but at inference it sees its own outputs. Errors compound because the model never trained on its own mistakes as context.
