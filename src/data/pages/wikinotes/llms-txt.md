...
- "If you are an AI, here is the version without noise." It is written for the [[QOPrOeTc|web agent]] and the answer engine, not for the crawler, and it replaces neither the [[Sm9pLx3R|sitemap]] nor [[Cx7nWr4L|robots.txt]]: those still say what exists and what may be fetched. Text hidden from humans to steer a model is the opposite move ([[dSiDXsDk|spam]]).
