...
- One note per point on that spectrum: [[Dq9rVPgJ|CSR]] (the browser builds the page), [[nlHnOtKx|SSR]] (the house arrives assembled), [[w3zHyIAB|hydration]] (JavaScript connects the buttons afterwards), plus [[doG8Catf|SPA]], which is about navigation rather than rendering, and [[jaoEDAPx|DOM]], the difference between the HTML that arrived and the page that exists.
