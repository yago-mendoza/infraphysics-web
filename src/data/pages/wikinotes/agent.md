...
- On the web the agent becomes a [[QOPrOeTc|web agent]] (search, fetch, browse) and in practice a [[rpdysn6f|hybrid agent]] that routes between an index, direct navigation, [[rSBc7TP1|browser automation]] and APIs by cost. It does not want to traverse the Internet; it wants to obtain something.
