...
- The protocol behind it is [[weeENcps|RFC 9309]] (2022), which fixes the matching rules and states plainly that this is not an authorization mechanism. The intuition: "do not enter" written on an open door. What must stay private needs [[4fbNv0Bm|authentication]]; robots.txt only shapes what a cooperative [[C3thKIgo|scheduler]] puts in its queue.
