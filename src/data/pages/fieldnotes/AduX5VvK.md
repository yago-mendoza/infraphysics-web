...
- Two foundational questions: "is this problem solvable?" (computability theory) and "how many resources does it take?" ([[4w2EhstR|complexity theory]])
- Core abstractions: algorithms, data structures, formal languages, automata, Turing machines.
- The Church-Turing thesis (1936): any function computable by an effective procedure can be computed by a Turing machine, defining the boundary of what computation can do.
