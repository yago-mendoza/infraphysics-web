...
- Another reason not to save enriched [[haA3MDhG|embeddings]] across passes: you'd need to recompute everything each time — [[mBCcy7bn|RNN]]-style dilution problem.
