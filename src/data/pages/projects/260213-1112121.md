...
category: projects
date: 2026-02-13
thumbnail: https://cdn.infraphysics.net/1112121-banner.png
...
A handful of real transactions reveals which brokers someone uses, their investment patterns, position sizes, and timing, more financial information than most people would ever share on purpose. The demo data shipped with this project is synthetic for exactly that reason. The lesson is blunt: never commit real personal data, even as a placeholder. Use `python -m http.server` and a generated dataset from the start.
{/bkqt}
