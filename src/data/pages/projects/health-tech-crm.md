---
slug: health-tech-crm
id: "3141592"
displayTitle: "A CRM for a health-tech startup, built solo in 72 hours"
subtitle: "Played as both the berserker and the integrator, just to feel the seam"
category: projects
date: "2026-03-14"
thumbnail: https://cdn.infraphysics.net/articles/3141592/cover.webp
thumbnailAspect: wide
thumbnailShading: heavy
description: "A bespoke CRM for a health-tech startup, designed and shipped solo in 72 hours. A real product built as an experiment in AI-assisted engineering: 23 tables, 8 state machines, automated enrichment and stale-relationship detection."
status: completed
tags: ["state machine","Cloudflare","relational database","healthcare"]
complexity: 5
...
{bkqt/keyconcept}
*The two-phase lifecycle.* Two questions, asked at different times, about the same person.

- Assess fit:: The general evaluation. Does this person belong in the 3C network at all? A contact starts as `new`, moves to `contacted` and then `evaluating`, and ends as `won` or `lost`.
- Prospect:: The project-specific one. Does this person fit *this particular quest*? The states are `new`, `contacted`, `in_conversation` and `opportunity`, again closing as `won` or `lost`.
