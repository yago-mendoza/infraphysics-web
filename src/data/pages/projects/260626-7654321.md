...
![Overlaid session trajectories on a dark background: cyan and orange lines tracing paths through a recent-density versus accumulated-load space.|The risk map: each simulated session as a trajectory through the density-load space; a few climb toward the danger corner.](https://cdn.infraphysics.net/7654321-fig-risk-map.png "center")
![A phase portrait of the density-and-load dynamics in cyan and orange, showing how the two state variables push each other around.|The phase portrait: how the fast clock (recent density) and the slow clock (accumulated load) push each other around.](https://cdn.infraphysics.net/7654321-fig-risk-phase.png "center")
