---
slug: is-there-a-wall-for-ai
id: "3841205"
displayTitle: "Is there a wall for AI?"
category: essays
date: "2026-02-03"
lang: en
thumbnail: https://cdn.infraphysics.net/articles/3841205/cover.webp
thumbnailAspect: banner
subtitle: "Scaling laws, broken ceilings, and a question that keeps answering itself."
tags: ["ML","neural network","scaling laws","large language model"]
complexity: 6
featured: true
...
{bkqt/keyconcept}
*The dinner party.* The core innovation is self-attention. Instead of reading text sequentially, the transformer looks at *all words simultaneously* and computes how much each one relates to every other.
...
{bkqt/warning}
*The capability overhang.* If we don't know what capabilities emerge at the next scale-up, we don't know what *dangerous* capabilities might emerge either. The system is developing abilities faster than we can catalog them. We're building something whose full capability set is partially unknown, even to the people building it.
{/bkqt}

# So is there a wall?

Every year I shorten the prediction. In 2022 I thought we had maybe a decade of significant progress left. In 2024 I stopped putting timelines on it. Not because I lost interest, but because the question changed. It stopped being "will AI keep improving?" and became "is this the one time the wall is real?"
...
## [[essays/9150483|The bitter lesson]]
...
{bkqt/warning}
*The data wall.* This isn't a compute problem or an architecture problem. It's a *data* problem. The transformer is hungry, and we're running out of food.
{/bkqt}
...
**[[https://sakana.ai|Sakana AI]]**, Tokyo lab founded by Llion Jones (one of the eight) and David Ha. Their bet: nature-inspired methods (evolutionary model merging, collective intelligence) can produce competitive models without brute-force scaling. If they're right, [[essays/9150483|the Bitter Lesson]] has an asterisk.
...
Nobody knows if there's a wall. But the people betting on one have been wrong every time so far, and the evidence against them gets stronger every quarter. The wall claim isn't impossible. It's just increasingly lonely. I know which side of that bet I'm on.
