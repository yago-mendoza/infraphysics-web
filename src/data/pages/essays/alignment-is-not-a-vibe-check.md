---
slug: alignment-is-not-a-vibe-check
id: "8888777"
displayTitle: "Alignment is not a vibe check"
category: essays
date: "2026-02-16"
lang: en
thumbnail: https://cdn.infraphysics.net/articles/8888777/cover.webp
thumbnailAspect: full
subtitle: "If you're not concerned about AI safety, you're not paying attention."
tags: ["ML","alignment","AI safety","RLHF","scaling laws"]
complexity: 6
featured: true
related: ["3841205", "9962668", "7270022"]
hidden: false
---
...
>
> — @doomposting_realist, mass-upvoted HN comment
...
I wrote about the shoggoth meme in [[essays/3841205|the transformers thread]], the Lovecraftian horror wearing a smiley-face mask. The horror is the raw model: a statistical completion engine of incomprehensible complexity that has absorbed the entirety of human text. The mask is alignment training: the layer that turns the alien thing into a helpful assistant. The question this entire field is trying to answer is: **how do you make the mask load-bearing?**
...
{bkqt/note}
*The Shift.* Think of it as the difference between manual code review and automated linting. RLHF is code review: a human examines every output and rates it. Constitutional AI is the linter: you encode the rules once, and the system self-corrects against them. RLHF scales linearly with human labor. Constitutional AI scales with compute.
{/bkqt}
...
## Apollo's deliberative alignment
...
{bkqt/warning}
*The Fine Print.* - **imperfect generalization**: rare but serious cases of misbehavior persisted. The remaining 0.3-0.4% isn't noise. The researchers describe some of these as "concerning."
...
## Anthropic and OpenAI test each other
