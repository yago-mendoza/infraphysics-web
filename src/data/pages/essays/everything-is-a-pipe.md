---
slug: everything-is-a-pipe
id: "7733621"
displayTitle: "Everything is a pipe"
category: essays
date: "2026-02-05"
lang: en
thumbnail: https://cdn.infraphysics.net/articles/7733621/cover.webp
thumbnailAspect: banner
subtitle: "Aqueducts, bloodstreams, TCP/IP. Same pattern, same solution."
tags: ["systems theory","infrastructure","networks"]
complexity: 2
featured: true
...
It should have clicked earlier. When I was studying engineering, my diagrams kept looking the same across subjects: thermodynamics, hydraulics, heat engines, control systems. Evolution built pipes. Romans built pipes. We built pipes. Apparently this is our thing. And a perceptron, I recently realized, is just a more sophisticated set of pipes.
...
{bkqt/note}
*The Congestion Window.* TCP doesn't just blast data at full speed. It starts slow: sends one packet, waits for acknowledgment. Then two. Then four. Doubling each time. This is called slow start, and it's TCP's way of probing the network's capacity without flooding it.
