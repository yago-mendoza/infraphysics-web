...
Sources, in order: `src/data/pages/README.md`, `src/data/pages/SYNTAX.md`, `src/data/pages/STYLE.md`, `src/data/pages/VOICE.md`, `src/data/pages/VISUAL.md`, `src/data/pages/bits2bricks/README.md`.
...
Typed boxes have no title ([STYLE.md](../../../src/data/pages/STYLE.md) rule 4): `{bkqt/tip}` and straight into the text. A lead, if needed, is the first sentence of the box.
